...
# Nếu đi trước: => Nên đi chéo
# -- Nếu tụi nó đi ngang dọc: đánh chéo auto win
# -- Nếu tụi nó đi chéo: đánh chéo theo hướng ngược lại thì khả năng cao hơn
# Nếu đi sau:  => Nên đi chéo
# - Nếu đi ngang dọc: => auto thua
# - Nếu đi chéo: => Nếu tụi nó đi chéo thì chéo ngược lại
...
class TicTacToe:
    ...
    def computerMove(self):
        ...
        # print("\033[94mComputer starts thinking\033[0m")
        # print()  # Dòng trống để tránh lem màu xuống dòng chữ phía dưới
        # print("\033[94m--------------------------------\033[0m")

        
        order = [(2, 2), (1, 1), (1, 3), (3, 1), (3, 3), (1, 2), (2, 1), (2, 3), (3, 2), (0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 0), (1, 4), (2, 0), (2, 4), (3, 0), (3, 4), (4, 0), (4, 1), (4, 2), (4, 3), (4, 4)]

        for i, j in order:
            if self.board[i][j] == " ":
                self.board[i][j] = "O"
                score = self.minimax(False, 1, float('-inf'), float('inf'))
        ...
        # print("\033[94mComputer finishes thinking\033[0m")
        # print()  # Dòng trống để tránh lem màu xuống dòng chữ phía dưới
        # print("\033[94m--------------------------------\033[0m")
    ...
    def minimax(self, isMaximizing, depth, alpha, beta):
        if depth == self.limit_search_depth or self.checkDraw():
            # self.printBoard()
            # print("\033[91mEVALUATED\033[0m", self.evaluate())
            # self.score.append((self.board, self.evaluate()))
            # count = 0 
            # for i in range(5):
            #     for j in range(5):
            #         if self.board[i][j] != " ":
            ...
            # print("\033[91mNotification\033[0m", count)
