...
class TicTacToe:
    ...
    def computerMove(self):
        ...
        if canWinIn1Move:
            ...
            return (canWinIn1Move[0], canWinIn1Move[1])
        ...
        if canLoseIn1Move: 
            ...
            return (canLoseIn1Move[0], canLoseIn1Move[1])        
        ...
        if canWinByFork:
            ...
            return (canWinByFork[0], canWinByFork[1])
        ...
        if canLoseByFork:
            ...
            return (canLoseByFork[0], canLoseByFork[1])
